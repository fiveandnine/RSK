...
app.get('*', async(req, res, next) => {
  try {
    ...
    let userAgent = req.headers['user-agent'].toLowerCase().match(/(iphone|ipod|ipad|android)/) ? 'mobile' : 'pc';
...
app.use((err, req, res, next) => {
  ...
  const html = ReactDOM.renderToStaticMarkup(
    ...
    >
    {ReactDOM.renderToString(<ErrorPageWithoutStyle
      error={err}/>)}
    </Html>,
  );
